...
public class SingleListActivity extends AdapterActivity<Single_Tweet> 
	...
	protected void onResume(){
		...
		this.id = intent.getStringExtra("list_id");
		BaseURL = "https://api.twitter.com/1.1/lists/statuses.json?list_id="+id + "&include_rts=1";
